    ...
    var table = [
        ...
        "images/1.jpg",
				...
				"images/2.jpg",
				 ...
				 "男",
				 "计算机科学与技术",
				 "作为一名大三在读学生,我已修读了几位前沿技术的必修课程,掌握了Java、MySQL、Spring、Redis等后台架构技术以及C++、Amazon EC2等云计算技术的运用。尤其在项目实践中,我独立完成了学生选修课程《学生信息管理系统》的设计开发,该系统是基于微服务架构的部署在AWS EC2云平台上的大型后台管理系统,拥有较为完善的安全认证、分布式事务、负载均衡等特点。",
				...
				"images/3.jpg",
				 ...
				 "男",
				 "计算机科学与技术",
				 "作为一名大三在读学生，我的热情始于我的专业课程，我在大学的课程中学习了许多经典的算法和数据结构，如排序算法、图算法、树和图的数据结构等。这些课程激发了我对算法和数据结构的兴趣，让我更深入地探索计算机科学的世界。为了深入了解算法和数据结构，我还参加了许多在线课程和MOOC，如Coursera、edX等。我在这些课程中学习了一些先进的算法和数据结构，如机器学习算法、深度学习算法、图像处理算法等，并在实践中应用这些技术来解决实际的问题",
